...
### Licenses
The theme uses three different licenses for separate parts of code. Make sure you read all three of them to make sure modifications/forks don't violate any of them.
